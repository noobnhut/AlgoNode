<template>
  ...
  <!-- Phân trang -->
  <Pagination v-if="algos.length > 5" v-slot="{ page }" :total="total_pages * per_page" :sibling-count="1" show-edges
    :default-page="1" @update:page="handlePageChange">
...
export default {
  data() {
    return {
      ...
      total_pages: 0,
      algoPath: this.$route.params.algoPath,
    };
  },
